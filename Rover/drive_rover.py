...
class RoverState():
    def __init__(self):
        ...
        self.memory_nav = set()     # save the mapped area to not be mapped again!
        self.memory_rocks = set()
        self.memory_obstacles = set()

        self.memory_obstacles_cart = set()
        self.memory_nav_cart  = set()
        self.memory_rocks_cart = set()
